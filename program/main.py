from data.inputs import parameters, scenarios, tariff_buy, FX
...
if __name__ == "__main__":
    ...
    sh = SmartHomeStochastic(parameters, scenarios, tariff_buy, FX)
    sh.build()
    sh.solve()
    sh.plot()
    ...
    bess_sweep(pv_opt, parameters, scenarios, tariff_buy, FX)